...
import qualified Simplicity.Programs.LockTime as LockTime
...
specificationBitcoin ParseLock = LockTime.parseLock
specificationBitcoin ParseSequence = LockTime.parseSequence
